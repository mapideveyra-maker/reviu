...
export default function Influencers() {
  const influencers = [
    { initials: 'SR', name: 'SarahEats', niche: 'Food & Dining', location: 'Cincinnati, OH', followers: '48.2K', engagement: '6.8%', tier: 'Rising Creator', tierColor: '#854F0B', tierBg: '#FAEEDA', score: 92 },
    { initials: 'MJ', name: 'MikeJohnsonLife', niche: 'Lifestyle & Food', location: 'Cincinnati, OH', followers: '124K', engagement: '4.2%', tier: 'Verified Influencer', tierColor: '#3C3489', tierBg: '#EEEDFE', score: 88 },
    { initials: 'TL', name: 'TasteWithTina', niche: 'Food & Beauty', location: 'Dayton, OH', followers: '8.9K', engagement: '9.1%', tier: 'Local Voice', tierColor: '#3B6D11', tierBg: '#EAF3DE', score: 96 },
    { initials: 'RC', name: 'RyanCreates', niche: 'Products & Tech', location: 'Columbus, OH', followers: '312K', engagement: '3.1%', tier: 'Top Creator', tierColor: '#185FA5', tierBg: '#E6F1FB', score: 84 },
    { initials: 'AW', name: 'AlexaWanders', niche: 'Food & Travel', location: 'Cincinnati, OH', followers: '22.1K', engagement: '7.4%', tier: 'Rising Creator', tierColor: '#854F0B', tierBg: '#FAEEDA', score: 90 },
  ]
    ...
    <main style={{
      ...
      <div style={{ padding: '1rem' }}>
        ...
        <div style={{
          ...
          ✦ Are you an influencer? <strong>Join Reviu free</strong> and connect directly with local businesses looking for collaborations.
        </div>
      ...
      <div style={{ position: 'fixed', bottom: 0, left: '50%', transform: 'translateX(-50%)', width: '100%', maxWidth: '430px', background: 'white', borderTop: '1px solid #eee', display: 'flex', justifyContent: 'space-around', padding: '12px 0 20px' }}>
        ...
        <Link href="/influencers" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '4px', textDecoration: 'none' }}>
          <span style={{ fontSize: '20px' }}>✦</span>
          <span style={{ fontSize: '11px', color: '#534AB7', fontWeight: '600' }}>Influencers</span>
        </Link>
