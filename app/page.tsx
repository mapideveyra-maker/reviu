...
export default function Home() {
  const businesses = [
    { id: 1, name: "Maria s Bakery and Cafe", cat: "Bakery", location: "Hyde Park", stars: 4.6, reviews: 182, score: 94, flag: 1 },
    ...
    { id: 5, name: "Dots Flower Shop", cat: "Retail", location: "Montgomery", stars: 4.7, reviews: 58, score: 89, flag: 2 },
  ...
  return (
    <main style={{ fontFamily: "sans-serif", maxWidth: "430px", margin: "0 auto", minHeight: "100vh", background: "#f7f7f5", paddingBottom: "80px" }}>
      <div style={{ background: "#534AB7", padding: "1rem 1.25rem", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <span style={{ fontSize: "22px", fontWeight: "700", color: "white", letterSpacing: "-0.5px" }}>Reviu</span>
      ...
      <div style={{ padding: "1rem" }}>
        ...
        {businesses.map(biz => (
          <Link href="/business" key={biz.id} style={{ background: "white", borderRadius: "16px", padding: "1rem 1.25rem", marginBottom: "12px", border: "1px solid #eee", display: "block", textDecoration: "none", color: "inherit" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "8px" }}>
              ...
              <div style={{ background: biz.score >= 90 ? "#EAF3DE" : biz.score >= 75 ? "#FAEEDA" : "#FCEBEB", color: biz.score >= 90 ? "#3B6D11" : biz.score >= 75 ? "#854F0B" : "#A32D2D", fontSize: "11px", fontWeight: "700", padding: "4px 8px", borderRadius: "8px" }}>{biz.score}% legit</div>
            </div>
            <div style={{ display: "flex", alignItems: "center", gap: "12px", fontSize: "13px", color: "#555" }}>
              ...
              {biz.flag > 0 && <span style={{ background: "#FCEBEB", color: "#A32D2D", fontSize: "11px", padding: "2px 8px", borderRadius: "6px", fontWeight: "600" }}>{biz.flag} suspicious</span>}
            </div>
          </Link>
        ))}
      </div>
