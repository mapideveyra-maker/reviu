  ...
  const reviews = [
    {
      ...
      score: 94,
      stars: 5,
      text: 'Incredible croissants and the staff remembered my name. My favorite neighborhood spot.',
      flags: ['Verified local', '247 reviews', '4.1 avg rating'],
      flagType: 'good',
      time: '1 week ago',
    },
    {
      ...
      score: 8,
      stars: 1,
      text: 'Health code violations everywhere. Do not eat here.',
      flags: ['Serial 1-star', '38 reviews all negative', 'No verified purchases'],
      flagType: 'bad',
      time: '5 days ago',
    },
    {
      ...
      flags: ['First review ever', 'Account 3 days old'],
      flagType: 'bad',
      time: '2 days ago',
    },
  ]
    ...
    <main style={{
        ...
        <div style={{
          ...
          <div>
            <div style={{
              ...
              fontWeight: '700',
              marginBottom: '4px',
            }}>{"Maria's Bakery & Cafe"}</div>
            <div style={{
              fontSize: '13px',
              color: '#888',
              marginBottom: '8px',
            }}>Bakery · Hyde Park, Cincinnati OH</div>
            <div style={{
              display: 'flex',
              alignItems: 'center',
              gap: '8px',
      ...
      <div style={{
        ...
        <div style={{
          ...
          marginBottom: '12px',
        }}>Review legitimacy breakdown</div>
          ...
          {[
            ...
            <div key={stat.label} style={{
              ...
              <div style={{
                fontSize: '16px',
                fontWeight: '700',
                color: stat.highlight ? '#3B6D11' : '#111',
              }}>{stat.value}</div>
            </div>
          ))}
        </div>
          ...
          <div key={review.name} style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                height: '36px',
                borderRadius: '50%',
                background: review.flagType === 'good' ? '#EAF3DE' : '#FCEBEB',
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center',
                fontSize: '12px',
                fontWeight: '700',
                color: review.flagType === 'good' ? '#3B6D11' : '#A32D2D',
                flexShrink: 0,
              }}>
              ...
              <div style={{ flex: 1 }}>
                <div style={{
                  ...
                  <span style={{
                    background: review.score > 50 ? '#EAF3DE' : '#FCEBEB',
                    color: review.score > 50 ? '#3B6D11' : '#A32D2D',
                    fontSize: '10px',
                    fontWeight: '700',
                    padding: '2px 6px',
                    borderRadius: '6px',
