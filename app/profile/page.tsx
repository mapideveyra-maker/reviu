    ...
    <main style={{ fontFamily: "sans-serif", maxWidth: "430px", margin: "0 auto", minHeight: "100vh", background: "#f7f7f5", paddingBottom: "80px" }}>
      ...
      <div style={{ background: "white", padding: "1.25rem", marginBottom: "8px" }}>
        <div style={{ display: "flex", gap: "16px", alignItems: "center", marginBottom: "16px" }}>
          <div style={{ width: "64px", height: "64px", borderRadius: "50%", background: "#EEEDFE", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "22px", fontWeight: "700", color: "#534AB7", flexShrink: 0 }}>ME</div>
          <div>
            ...
            <div style={{ display: "inline-block", background: "#EAF3DE", color: "#3B6D11", fontSize: "11px", fontWeight: "700", padding: "3px 10px", borderRadius: "20px" }}>Verified Reviewer</div>
          </div>
        </div>
      ...
      <div style={{ background: "white", padding: "1.25rem", marginBottom: "8px" }}>
        ...
        {[
          { biz: "Maria s Bakery and Cafe", stars: 5, text: "Best croissants in Cincinnati. Always fresh and the staff is wonderful.", time: "2 weeks ago" },
          { biz: "Blue Lotus Yoga", stars: 5, text: "Amazing classes and a very welcoming community.", time: "1 month ago" },
          { biz: "Kingpin Barber Co", stars: 3, text: "Good haircut but had to wait 45 minutes past my appointment.", time: "2 months ago" },
        ].map(review => (
      ...
      <div style={{ background: "white", padding: "1.25rem", marginBottom: "8px" }}>
        ...
        {[
          ...
          <div key={item.label} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "12px 0", borderBottom: "1px solid #f5f5f5", cursor: "pointer" }}>
            <div>
