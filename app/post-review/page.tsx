    ...
    <main style={{ fontFamily: "sans-serif", maxWidth: "430px", margin: "0 auto", minHeight: "100vh", background: "#f7f7f5", paddingBottom: "80px" }}>
      ...
      <div style={{ padding: "1rem" }}>
        <div style={{ background: "white", borderRadius: "16px", padding: "1.25rem", marginBottom: "12px", border: "1px solid #eee" }}>
          ...
          <input type="text" placeholder="Business name or address..." style={{ width: "100%", padding: "12px 16px", borderRadius: "12px", border: "1px solid #e5e5e5", fontSize: "14px", background: "#f7f7f5", boxSizing: "border-box" }} />
          <div style={{ marginTop: "12px" }}>
            {["Maria s Bakery and Cafe", "Rosario Italian Kitchen", "Blue Lotus Yoga"].map(biz => (
              <div key={biz} style={{ padding: "12px", borderRadius: "10px", background: "#f7f7f5", marginBottom: "8px", fontSize: "14px", cursor: "pointer", border: "1px solid #eee" }}>{biz}</div>
            ))}
          </div>
        </div>
        <div style={{ background: "white", borderRadius: "16px", padding: "1.25rem", marginBottom: "12px", border: "1px solid #eee" }}>
          ...
          <div style={{ display: "flex", gap: "12px", justifyContent: "center", marginBottom: "8px" }}>
            {[1, 2, 3, 4, 5].map(star => (
              <span key={star} onClick={() => setStars(star)} onMouseEnter={() => setHover(star)} onMouseLeave={() => setHover(0)} style={{ fontSize: "36px", cursor: "pointer", color: star <= (hover || stars) ? "#f59e0b" : "#ddd" }}>★</span>
            ))}
          </div>
          <div style={{ textAlign: "center", fontSize: "13px", color: "#888" }}>
            {stars === 0 && "Tap to rate"}{stars === 1 && "Poor"}{stars === 2 && "Fair"}{stars === 3 && "Good"}{stars === 4 && "Very Good"}{stars === 5 && "Excellent"}
          </div>
        </div>
        <div style={{ background: "white", borderRadius: "16px", padding: "1.25rem", marginBottom: "12px", border: "1px solid #eee" }}>
          ...
          <textarea placeholder="Tell others about your experience. Be specific and honest — your review will be verified for legitimacy." style={{ width: "100%", padding: "12px 16px", borderRadius: "12px", border: "1px solid #e5e5e5", fontSize: "14px", background: "#f7f7f5", minHeight: "120px", resize: "none", boxSizing: "border-box", lineHeight: "1.5" }} />
        </div>
        <div style={{ background: "#EEEDFE", borderRadius: "12px", padding: "12px 16px", marginBottom: "16px", fontSize: "13px", color: "#3C3489", lineHeight: "1.5" }}>
          🛡️ <strong>Reviu legitimacy check:</strong> Your review and profile will be analyzed to ensure authenticity.
        </div>
        <div style={{ background: "#534AB7", color: "white", padding: "16px", borderRadius: "14px", fontSize: "15px", fontWeight: "600", textAlign: "center", cursor: "pointer" }}>Submit Review</div>
      </div>
