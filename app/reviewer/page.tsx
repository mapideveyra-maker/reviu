  ...
  return (
    <main style={{ fontFamily: "sans-serif", maxWidth: "430px", margin: "0 auto", minHeight: "100vh", background: "#f7f7f5", paddingBottom: "80px" }}>
      <div style={{ background: "#534AB7", padding: "1rem 1.25rem", display: "flex", alignItems: "center", gap: "12px" }}>
        ...
        <span style={{ fontSize: "16px", fontWeight: "600", color: "white" }}>Reviewer Profile</span>
      </div>
      <div style={{ background: "white", padding: "1.25rem", marginBottom: "8px" }}>
        <div style={{ display: "flex", gap: "16px", alignItems: "flex-start", marginBottom: "16px" }}>
          <div style={{ width: "60px", height: "60px", borderRadius: "50%", background: "#FCEBEB", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "20px", fontWeight: "700", color: "#A32D2D", flexShrink: 0 }}>TC</div>
          <div style={{ flex: 1 }}>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: "6px" }}>
              {[
                ...
                <span key={badge.text} style={{ fontSize: "11px", fontWeight: "600", padding: "3px 8px", borderRadius: "6px", background: badge.bg, color: badge.color }}>{badge.text}</span>
              ))}
            </div>
          </div>
          <div style={{ textAlign: "center" }}>
            <div style={{ width: "56px", height: "56px", borderRadius: "50%", background: "#FCEBEB", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", marginBottom: "4px" }}>
      ...
      <div style={{ background: "white", padding: "1.25rem", marginBottom: "8px" }}>
        <div style={{ fontSize: "13px", fontWeight: "600", color: "#888", textTransform: "uppercase", letterSpacing: "0.05em", marginBottom: "12px" }}>Review pattern</div>
      ...
      <div style={{ background: "white", padding: "1.25rem", marginBottom: "8px" }}>
        <div style={{ fontSize: "13px", fontWeight: "600", color: "#888", textTransform: "uppercase", letterSpacing: "0.05em", marginBottom: "12px" }}>Online presence</div>
        {[
          ...
          <div key={item.platform} style={{ display: "flex", alignItems: "center", gap: "10px", padding: "10px 0", borderBottom: "1px solid #f5f5f5" }}>
            <div style={{ width: "36px", height: "36px", borderRadius: "8px", background: "#EEEDFE", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "11px", fontWeight: "700", color: "#534AB7", flexShrink: 0 }}>{item.platform.slice(0, 2)}</div>
            <div style={{ flex: 1 }}>
            ...
            <span style={{ fontSize: "11px", fontWeight: "600", padding: "3px 8px", borderRadius: "6px", background: item.bg, color: item.color, whiteSpace: "nowrap" }}>{item.status}</span>
          </div>
        ))}
      </div>
      <div style={{ background: "white", padding: "1.25rem", marginBottom: "8px" }}>
        <div style={{ fontSize: "13px", fontWeight: "600", color: "#888", textTransform: "uppercase", letterSpacing: "0.05em", marginBottom: "12px" }}>Recent reviews left</div>
        {[
          ...
          { biz: "Dots Flower Shop", stars: 1, text: "Never again. Worst customer service I have ever seen.", time: "1 month ago" },
        ].map(review => (
          <div key={review.biz} style={{ paddingBottom: "12px", marginBottom: "12px", borderBottom: "1px solid #f5f5f5" }}>
            ...
            <div style={{ fontSize: "12px", color: "#f59e0b", marginBottom: "4px" }}>{"★".repeat(review.stars)}{"☆".repeat(5 - review.stars)}</div>
